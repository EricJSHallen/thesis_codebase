...
Interactive Matplotlib viewer for formatted Vthr phase-shift CSV outputs.
...
KIND_TO_FORMATTED_SUBDIR = {
    "1syn": "phase_shift_1syn_vthr_v2",
    "2syn": "phase_shift_2syn_vthr_v2",
}
...
def parse_args(argv: Optional[list[str]] = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Display formatted Vthr phase-shift CSVs as interactive Matplotlib plots."
    )
