...
Interactive Matplotlib viewer for formatted Vtau phase-shift CSV outputs.
...
KIND_TO_FORMATTED_SUBDIR = {
    "1syn": "phase_shift_1syn_vtau_v2",
    "2syn": "phase_shift_2syn_vtau_v2",
}
...
def parse_args(argv: Optional[list[str]] = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Display formatted Vtau phase-shift CSVs as interactive Matplotlib plots."
    )
