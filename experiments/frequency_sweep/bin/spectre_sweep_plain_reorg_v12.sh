...
# Remove any previously inserted strobeperiod option.  The user requested full
# adaptive-output data, so this flow deliberately does not constrain output
# samples to a strobe grid.
...
echo "=== Plain Spectre frequency sweep reorg v12 prep ==="
echo "Repo:       $REPO_DIR"
