...
From the repository root:
    ...
    python processing/previews/avg_integral_v7.py --summary-only
    python processing/previews/avg_integral_v7.py --max-combinations 5 --verbose
    python processing/previews/avg_integral_v7.py --save-csv
...
def default_output_csv() -> Path:
    return Path(__file__).resolve().parent / "average_integrated_voltage_difference_v7.csv"
...
def parse_args(argv: Sequence[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        help="Print progress every N generated frequency-combination results. Default: 50.",
    )
