...
# spectre_sweep_plain_v3.sh
# Single-OCEAN-template + parallel plain-Spectre pipeline.
# Fixes: robust Spectre runtime library discovery, including libSpectreEH_sh.so, and BrokenPipe/early-worker-exit logic.
...
case "$MODE" in
  prep)
    echo "=== Plain Spectre sweep prep v3 ==="
    echo "Repo:        $REPO_DIR"
...
ARCHITECTURE=single_ocean_template_then_parallel_plain_spectre_v3
INFO
